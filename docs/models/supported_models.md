...
| `InternLM2VEForCausalLM` | InternVL2 | `OpenGVLab/Mono-InternVL-2B`, etc. | ✅︎ | ✅︎ |
...
| `Llama4ForCausalLM` | Llama 4 | `meta-llama/Llama-4-Scout-17B-16E-Instruct`, etc. | ✅︎ | ✅︎ |
...
| `Step3TextForCausalLM` | Step3-Text | `stepfun-ai/step3`, etc. | | ✅︎ |
